[![Go build status](https://github.com/Fast-IQ/notify-lock-session/actions/workflows/go.yml/badge.svg?branch=main)](https://github.com/Fast-IQ/notify-lock-session/actions/workflows/go.yml?query=branch%3Amain)
